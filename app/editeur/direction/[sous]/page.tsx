      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-14 text-center">
            ...
            <p className="text-xs font-semibold text-blue-600 uppercase tracking-[0.2em] mb-4">Éditeur de SaaS · Direction</p>
        ...
        <section className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          ...
          <div className="mt-14 text-center">
            <div className="inline-flex flex-col items-center gap-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm px-8 py-8 sm:px-10 sm:py-9 max-w-md">
              ...
              <a href={`${platformUrl}/auth/editor`} className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl shadow-sm hover:shadow transition-all">
